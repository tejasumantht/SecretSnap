...
def print_credits():
	...
	table.add_row("Teja Sumanth ", "tejasumanth.t@gmail.com ","+91 9550512562")
	console.print(table)
...
if __name__ == "__main__":
	...
	cprint(figlet_format('Secret_Snap', font='slant'),'yellow', attrs=['bold'])
	print_credits()
	print()
	print("[bold]SecretSnap[/bold] by Teja Sumanth.")
	print()
